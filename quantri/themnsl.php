<?php
	...
	if(isset($_POST['submit'])){
		...
		/*
		$txt = $submit_ten_nsl->submit."\n";
			$myFile = fopen('newFile', 'a+');
			
			fwrite($myFile, $submit_ten_nsl.'\n'.
							   $myFile, $submit_ma_nsl.'\n'.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
							   $myFile, $submit_hoc_van.'\n'.
							   $myFile, $submit_tay_ghe.'\n'.
							   $myFile, $submit_don_vi.'\n'.
							   $myFile, $submit_ghi_chu.'\n'
							   );*/
        	...
        	<form method="post" enctype="multipart/form-data">
                <table id="add-prd" border="0" cellpadding="0" cellspacing="0">
                   ...
                   <tr>
                    ...
                    <tr>
                       <td><label>Ghi chú</label><br /><textarea cols="60" rows="12" name="ghi_chu"></textarea>
